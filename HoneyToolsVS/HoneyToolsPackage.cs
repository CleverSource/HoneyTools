...
namespace HoneyToolsVS
{
	...
	[ProvideOptionPage(typeof(HoneyToolsGeneralOptions), "Honey Tools", "General", 0, 0, true)]
	...
	public sealed class HoneyToolsPackage : AsyncPackage
	{
		/// <summary>
		...
		public static HoneyToolsPackage Instance { get; private set; }

		public HoneyToolsPackage()
		{
			Instance = this;
		}

		internal HoneySolutionEventsListener SolutionEventsListener { get; private set; }
		internal HoneyToolsGeneralOptions GeneralOptions => GetDialogPage(typeof(HoneyToolsGeneralOptions)) as HoneyToolsGeneralOptions;
		...
		protected override async Task InitializeAsync(CancellationToken cancellationToken, IProgress<ServiceProgressData> progress)
		{
			...
			await AttachHoneynutCommand.InitializeAsync(this);

			SolutionEventsListener = new HoneySolutionEventsListener(this);
		}
